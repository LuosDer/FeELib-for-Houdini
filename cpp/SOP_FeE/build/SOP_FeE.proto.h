...
class  SOP_FeEParms  : public SOP_NodeParms
{
public:
    ...
    explicit SOP_FeEParms(const SOP_FeEParms &) = default;

    ~SOP_FeEParms() override {}

    bool operator==(const SOP_FeEParms &src) const
    {
    ...
    using GroupType = SOP_FeEEnums::GroupType;
    using AttribClass = SOP_FeEEnums::AttribClass;
