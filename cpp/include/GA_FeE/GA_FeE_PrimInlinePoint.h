...
#ifndef __GA_FeE_PrimInlinePoint_h__
#define __GA_FeE_PrimInlinePoint_h__
...
class GA_FeE_PrimInlinePoint {


public:
    GA_FeE_PrimInlinePoint(
...
namespace GA_FeE_PrimInlinePoint {
...
} // End of namespace GA_FeE_PrimInlinePoint
