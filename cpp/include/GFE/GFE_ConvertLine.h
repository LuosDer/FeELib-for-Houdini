...
)
{
    ...
    const GA_RWHandleT<GA_Offset> dstptAttrib_h = geoTmp->findVertexAttribute(GFE_TOPO_SCOPE, "__topo_dstpt");
...
)
{
    ...
    //const GA_Attribute* dstptAttrib = geoPoint->findVertexAttribute("__topo_dstpt");
    const GA_RWHandleT<GA_Offset> dstptAttrib_h = geoFullTmp->findVertexAttribute(GFE_TOPO_SCOPE, "__topo_dstpt");
