...
#ifndef __SOP_FeE_BezierCurveInsertPoint_1_0_h__
#define __SOP_FeE_BezierCurveInsertPoint_1_0_h__

#include <SOP/SOP_Node.h>
#include <UT/UT_StringHolder.h>

namespace SOP_FeE_BezierCurveInsertPoint_1_0_Namespace {
...
protected:
    SOP_FeE_BezierCurveInsertPoint_1_0(OP_Network *net, const char *name, OP_Operator *op)
    ...
    ~SOP_FeE_BezierCurveInsertPoint_1_0() override {}
...
} // End SOP_FeE_BezierCurveInsertPoint_1_0_Namespace namespace
