...
PRM_Template*
SOP_FeE_Enumerate_1_0::buildTemplates()
{
    static PRM_TemplateBuilder templ("SOP_FeE_Enumerate_1_0.C"_sh, theDsFile);
    if (templ.justBuilt())
    {
...
const UT_StringHolder SOP_FeE_Enumerate_1_0::theSOPTypeName("FeE::enumerate::1.0"_sh);

void
newSopOperator(OP_OperatorTable* table)
{
    OP_Operator* newOp = new OP_Operator(
        SOP_FeE_Enumerate_1_0::theSOPTypeName,
        "FeE Enumerate",
        SOP_FeE_Enumerate_1_0::myConstructor,
        SOP_FeE_Enumerate_1_0::buildTemplates(),
        1,
        1,
        nullptr,
...
class SOP_FeE_Enumerate_1_0Verb : public SOP_NodeVerb
{
public:
    SOP_FeE_Enumerate_1_0Verb() {}
    virtual ~SOP_FeE_Enumerate_1_0Verb() {}
    ...
    static const SOP_NodeVerb::Register<SOP_FeE_Enumerate_1_0Verb> theVerb;
};

// The static member variable definition has to be outside the class definition.
// The declaration is inside the class.
const SOP_NodeVerb::Register<SOP_FeE_Enumerate_1_0Verb> SOP_FeE_Enumerate_1_0Verb::theVerb;

const SOP_NodeVerb *
SOP_FeE_Enumerate_1_0::cookVerb() const 
{ 
    return SOP_FeE_Enumerate_1_0Verb::theVerb.get();
}
...
void
SOP_FeE_Enumerate_1_0Verb::cook(const SOP_NodeVerb::CookParms &cookparms) const
{
    auto&& sopparms = cookparms.parms<SOP_FeE_Enumerate_1_0Parms>();
    ...
    GFE_Enumerate enumerate(cookparms, outGeo0);
