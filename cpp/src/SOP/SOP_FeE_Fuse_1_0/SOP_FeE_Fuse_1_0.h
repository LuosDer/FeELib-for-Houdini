...
#ifndef __SOP_FeE_Fuse_1_0_h__
#define __SOP_FeE_Fuse_1_0_h__

#include <SOP/SOP_Node.h>
#include <UT/UT_StringHolder.h>

namespace SOP_FeE_Fuse_1_0_Namespace {

class SOP_FeE_Fuse_1_0 : public SOP_Node
{
public:
    static PRM_Template *buildTemplates();
    static OP_Node *myConstructor(OP_Network *net, const char *name, OP_Operator *op)
    {
        OP_Node* newOp = new SOP_FeE_Fuse_1_0(net, name, op);
...
protected:
    SOP_FeE_Fuse_1_0(OP_Network *net, const char *name, OP_Operator *op)
...
} // End SOP_FeE_Fuse_1_0_Namespace namespace
