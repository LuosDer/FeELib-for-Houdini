...
static bool
sopPrimPolyIsClosed(SOP_FeE_Triangulate2D_2_0Parms::PrimType parmgrouptype)
{
...
SOP_FeE_Triangulate2D_2_0Verb::cook(const SOP_NodeVerb::CookParms &cookparms) const
{
    ...
    GA_FeE_Triangulat2D::triangulat2D(outGeo0, sopparms.getOutTopoAttrib());
...
namespace SOP_FeE_Triangulate2D_2_0_Namespace {

} // End SOP_FeE_Triangulate2D_2_0_Namespace namespace
