...
SYS_FORCE_INLINE
        ...
        )
    {
        ...
        //{
        //}
        const GA_Group* groupRefPromoted = nullptr;
        ...
        {
            GA_GroupUPtr groupRefPromotedUPtr = GFE_GroupPromote::groupPromoteDetached(groupRef, attrib->getOwner());
        ...
        //    break;
        case GA_STORE_UINT8:
            attribCombine<uint8>(attrib, groupRefPromoted, subscribeRatio, minGrainSize);
            break;
        case GA_STORE_INT8:
            attribCombine<int8>(attrib, groupRefPromoted, subscribeRatio, minGrainSize);
            break;
        case GA_STORE_INT16:
            attribCombine<int16>(attrib, groupRefPromoted, subscribeRatio, minGrainSize);
            break;
        case GA_STORE_INT32:
            attribCombine<int32>(attrib, groupRefPromoted, subscribeRatio, minGrainSize);
            break;
        case GA_STORE_INT64:
            attribCombine<int64>(attrib, groupRefPromoted, subscribeRatio, minGrainSize);
            break;
        case GA_STORE_REAL16:
            attribCombine<fpreal16>(attrib, groupRefPromoted, subscribeRatio, minGrainSize);
            break;
        case GA_STORE_REAL32:
            attribCombine<fpreal32>(attrib, groupRefPromoted, subscribeRatio, minGrainSize);
            break;
        case GA_STORE_REAL64:
            attribCombine<fpreal64>(attrib, groupRefPromoted, subscribeRatio, minGrainSize);
            break;
        case GA_STORE_STRING:
            attribCombine<UT_StringHolder>(attrib, groupRefPromoted, subscribeRatio, minGrainSize);
            break;
        default:
            UT_ASSERT_MSG(0, "unsupport storage");
            return false;
            break;
        }
        return true;
