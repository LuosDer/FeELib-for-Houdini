...
class SOP_FeE_VDBActivateByPoint_1_0Verb : public SOP_NodeVerb
{
public:
    SOP_FeE_VDBActivateByPoint_1_0Verb() {}
    virtual ~SOP_FeE_VDBActivateByPoint_1_0Verb() {}

    virtual SOP_NodeParms *allocParms() const { return new SOP_FeE_VDBActivateByPoint_1_0Parms(); }
    virtual UT_StringHolder name() const { return SOP_FeE_VDBActivateByPoint_1_0::theSOPTypeName; }
...
const SOP_NodeVerb *
SOP_FeE_VDBActivateByPoint_1_0::cookVerb() const 
{ 
    return SOP_FeE_VDBActivateByPoint_1_0Verb::theVerb.get();
}
...
static GA_GroupType
sopGroupType(const SOP_FeE_VDBActivateByPoint_1_0Parms::GroupType parmGroupType)
{
...
void
SOP_FeE_VDBActivateByPoint_1_0Verb::cook(const SOP_NodeVerb::CookParms &cookparms) const
{
    auto&& sopparms = cookparms.parms<SOP_FeE_VDBActivateByPoint_1_0Parms>();
