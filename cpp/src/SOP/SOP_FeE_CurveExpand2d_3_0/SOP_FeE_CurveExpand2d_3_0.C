...
#include "SOP_FeE_CurveExpand2d_3_0.h"


#include "SOP_FeE_CurveExpand2d_3_0.proto.h"
...
using namespace SOP_FeE_CurveExpand2d_3_0_Namespace;
...
PRM_Template*
SOP_FeE_CurveExpand2d_3_0::buildTemplates()
{
    static PRM_TemplateBuilder templ("SOP_FeE_CurveExpand2d_3_0.C"_sh, theDsFile);
    if (templ.justBuilt())
    {
...
const UT_StringHolder SOP_FeE_CurveExpand2d_3_0::theSOPTypeName("FeE::curveExpand2d::3.0"_sh);

void
newSopOperator(OP_OperatorTable* table)
{
    OP_Operator* newOp = new OP_Operator(
        SOP_FeE_CurveExpand2d_3_0::theSOPTypeName,
        "FeE Curve Expand 2D",
        SOP_FeE_CurveExpand2d_3_0::myConstructor,
        SOP_FeE_CurveExpand2d_3_0::buildTemplates(),
        1,
        1,
        nullptr,
...
class SOP_FeE_CurveExpand2d_3_0Verb : public SOP_NodeVerb
{
public:
    SOP_FeE_CurveExpand2d_3_0Verb() {}
    virtual ~SOP_FeE_CurveExpand2d_3_0Verb() {}

    virtual SOP_NodeParms *allocParms() const { return new SOP_FeE_CurveExpand2d_3_0Parms(); }
    virtual UT_StringHolder name() const { return SOP_FeE_CurveExpand2d_3_0::theSOPTypeName; }
    ...
    static const SOP_NodeVerb::Register<SOP_FeE_CurveExpand2d_3_0Verb> theVerb;
};

// The static member variable definition has to be outside the class definition.
// The declaration is inside the class.
const SOP_NodeVerb::Register<SOP_FeE_CurveExpand2d_3_0Verb> SOP_FeE_CurveExpand2d_3_0Verb::theVerb;

const SOP_NodeVerb *
SOP_FeE_CurveExpand2d_3_0::cookVerb() const 
{ 
    return SOP_FeE_CurveExpand2d_3_0Verb::theVerb.get();
}
...
void
SOP_FeE_CurveExpand2d_3_0Verb::cook(const SOP_NodeVerb::CookParms &cookparms) const
{
    auto&& sopparms = cookparms.parms<SOP_FeE_CurveExpand2d_3_0Parms>();
    GA_Detail* const outGeo0 = cookparms.gdh().gdpNC();
    //auto sopcache = (SOP_FeE_CurveExpand2d_3_0Cache*)cookparms.cache();
...
namespace SOP_FeE_CurveExpand2d_3_0_Namespace {

} // End SOP_FeE_CurveExpand2d_3_0_Namespace namespace
