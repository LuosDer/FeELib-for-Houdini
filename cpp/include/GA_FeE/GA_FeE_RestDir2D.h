...
#ifndef __GA_FeE_RestDir2D_h__
#define __GA_FeE_RestDir2D_h__
...
enum GA_FeE_RestDir2D_Method
{
	GA_FeE_RestDir2D_AvgNormal,
	GA_FeE_RestDir2D_HouOBB,
};


namespace GA_FeE_RestDir2D {
...
restDir2D(
	const GA_Detail* const geo,
	const GA_PrimitiveGroup* const geoPrimGroup = nullptr,
	const GA_FeE_RestDir2D_Method method = GA_FeE_RestDir2D_AvgNormal,
	const exint subscribeRatio = 64,
	const exint minGrainSize = 1024
)
{
...
addAttribRestDir2D(
	...
	const GA_FeE_RestDir2D_Method method,
	const GA_Storage storage = GA_STORE_INVALID,
	const UT_StringHolder& name = "__topo_restDir2D",
	const UT_Options* const creation_args = nullptr,
	const GA_AttributeOptions* const attribute_options = nullptr,
...
)
{
	...
	const GA_PrimitiveGroup* const geoPrimGroup = GA_FeE_GroupPromote::groupFindPromotePrimitiveDetached(geo, geoGroup);
...
} // End of namespace GA_FeE_RestDir2D
