...
#ifndef __GA_FeE_ExtendCurveStraight_h__
#define __GA_FeE_ExtendCurveStraight_h__
...
namespace GA_FeE_ExtendCurveStraight {
...
)
{
    ...
    GOP_Manager gop;
    const GA_PrimitiveGroup* const primGroup = GA_FeE_Group::findOrParsePrimitiveGroupDetached(cookparms, geo, primGroupName, gop);
...
} // End of namespace GA_FeE_ExtendCurveStraight
