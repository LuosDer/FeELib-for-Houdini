...
#ifndef __GFE_BezierCurveInsertPoint_h__
#define __GFE_BezierCurveInsertPoint_h__

#include "GFE/GFE_BezierCurveInsertPoint.h"
...
class GFE_BezierCurveInsertPoint : public GFE_AttribFilter {
...
}; // End of class GFE_BezierCurveInsertPoint
