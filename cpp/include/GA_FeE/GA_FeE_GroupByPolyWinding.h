...
#ifndef __GA_FeE_GroupByPolyWinding_h__
#define __GA_FeE_GroupByPolyWinding_h__
...
namespace GA_FeE_GroupByPolyWinding {
...
groupByPolyWinding_restDir2D(
	...
	const GA_Attribute* const normalAttrib,
	const GA_PrimitiveGroup* const geoPrimGroup = nullptr,
	const GA_FeE_RestDir2D_Method restDir2DMethod = GA_FeE_RestDir2D_AvgNormal,
	const bool reverseGroup = false,
	const exint subscribeRatio = 64,
	const exint minGrainSize = 1024
)
{
	const UT_Vector3T<T>& dir2D = GA_FeE_RestDir2D::restDir2D<T>(geo, geoPrimGroup, restDir2DMethod);
	groupByPolyWinding<T>(geo, reversedGroup, normalAttrib, dir2D,
		geoPrimGroup, reverseGroup,
		subscribeRatio, minGrainSize);
}
...
)
{
	...
	case GFE_GroupByPolyWindingMethod_RestDir2D_AvgNormal:
		groupByPolyWinding_restDir2D<fpreal>(geo, reversedGroup, normalAttrib,
			...
			subscribeRatio, minGrainSize);
		break;
	case GA_FeE_GroupByPolyWinding_RestDir2D_HouOBB:
		groupByPolyWinding_restDir2D<fpreal>(geo, reversedGroup, normalAttrib,
			geoPrimGroup, GA_FeE_RestDir2D_HouOBB,
			reverseGroup,
			subscribeRatio, minGrainSize);
		break;
	case GA_FeE_GroupByPolyWinding_Ray:
...
} // End of namespace GA_FeE_GroupByPolyWinding
