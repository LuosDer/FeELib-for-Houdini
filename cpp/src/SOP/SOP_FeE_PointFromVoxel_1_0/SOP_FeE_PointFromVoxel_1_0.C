...
#include "SOP_FeE_PointFromVoxel_1_0.h"


#include "SOP_FeE_PointFromVoxel_1_0.proto.h"
...
using namespace SOP_FeE_PointFromVoxel_1_0_Namespace;
...
PRM_Template*
SOP_FeE_PointFromVoxel_1_0::buildTemplates()
{
    static PRM_TemplateBuilder templ("SOP_FeE_PointFromVoxel_1_0.C"_sh, theDsFile);
    if (templ.justBuilt())
    {
...
const UT_StringHolder SOP_FeE_PointFromVoxel_1_0::theSOPTypeName("FeE::pointFromVoxel::1.0"_sh);

void
newSopOperator(OP_OperatorTable* table)
{
    OP_Operator* newOp = new OP_Operator(
        SOP_FeE_PointFromVoxel_1_0::theSOPTypeName,
        "FeE Point from Voxel",
        SOP_FeE_PointFromVoxel_1_0::myConstructor,
        SOP_FeE_PointFromVoxel_1_0::buildTemplates(),
        1,
        1,
        nullptr,
        ...
        nullptr,
        1,
        "Five elements Elf/Generator/Volume");

    newOp->setIconName("SOP_pointsfromvolume");
...
class SOP_FeE_PointFromVoxel_1_0Verb : public SOP_NodeVerb
{
public:
    SOP_FeE_PointFromVoxel_1_0Verb() {}
    virtual ~SOP_FeE_PointFromVoxel_1_0Verb() {}
    ...
    static const SOP_NodeVerb::Register<SOP_FeE_PointFromVoxel_1_0Verb> theVerb;
};

// The static member variable definition has to be outside the class definition.
// The declaration is inside the class.
const SOP_NodeVerb::Register<SOP_FeE_PointFromVoxel_1_0Verb> SOP_FeE_PointFromVoxel_1_0Verb::theVerb;

const SOP_NodeVerb *
SOP_FeE_PointFromVoxel_1_0::cookVerb() const 
{ 
    return SOP_FeE_PointFromVoxel_1_0Verb::theVerb.get();
}
...
static GA_GroupType
sopGroupType(const SOP_FeE_PointFromVoxel_1_0Parms::GroupType parmGroupType)
{
    using namespace SOP_FeE_PointFromVoxel_1_0Enums;
...
sopAttribOwner(const SOP_FeE_PointFromVoxel_1_0Parms::Class parmAttribClass)
{
    using namespace SOP_FeE_PointFromVoxel_1_0Enums;
...
sopStorageClass(const SOP_FeE_PointFromVoxel_1_0Parms::StorageClass parmStorageClass)
{
    using namespace SOP_FeE_PointFromVoxel_1_0Enums;
...
void
SOP_FeE_PointFromVoxel_1_0Verb::cook(const SOP_NodeVerb::CookParms &cookparms) const
{
    auto&& sopparms = cookparms.parms<SOP_FeE_PointFromVoxel_1_0Parms>();
