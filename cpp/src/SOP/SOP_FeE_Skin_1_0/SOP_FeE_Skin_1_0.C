...
#include "SOP_FeE_Skin_1_0.h"


#include "SOP_FeE_Skin_1_0.proto.h"
...
using namespace SOP_FeE_Skin_1_0_Namespace;
...
PRM_Template*
SOP_FeE_Skin_1_0::buildTemplates()
{
...
const UT_StringHolder SOP_FeE_Skin_1_0::theSOPTypeName("FeE::skin::3.0"_sh);

void
newSopOperator(OP_OperatorTable* table)
{
    OP_Operator* newOp = new OP_Operator(
        SOP_FeE_Skin_1_0::theSOPTypeName,
        "FeE Skin",
        SOP_FeE_Skin_1_0::myConstructor,
        SOP_FeE_Skin_1_0::buildTemplates(),
        1,
        2,
        nullptr,
...
class SOP_FeE_Skin_1_0Verb : public SOP_NodeVerb
{
public:
    SOP_FeE_Skin_1_0Verb() {}
    virtual ~SOP_FeE_Skin_1_0Verb() {}

    virtual SOP_NodeParms *allocParms() const { return new SOP_FeE_Skin_1_0Parms(); }
    virtual UT_StringHolder name() const { return SOP_FeE_Skin_1_0::theSOPTypeName; }
    ...
    static const SOP_NodeVerb::Register<SOP_FeE_Skin_1_0Verb> theVerb;
};

// The static member variable definition has to be outside the class definition.
// The declaration is inside the class.
const SOP_NodeVerb::Register<SOP_FeE_Skin_1_0Verb> SOP_FeE_Skin_1_0Verb::theVerb;

const SOP_NodeVerb *
SOP_FeE_Skin_1_0::cookVerb() const 
{ 
    return SOP_FeE_Skin_1_0Verb::theVerb.get();
}
...
static bool
sopPrimPolyIsClosed(SOP_FeE_Skin_1_0Parms::PrimType parmgrouptype)
{
    using namespace SOP_FeE_Skin_1_0Enums;
...
namespace SOP_FeE_Skin_1_0_Namespace {

} // End SOP_FeE_Skin_1_0_Namespace namespace
