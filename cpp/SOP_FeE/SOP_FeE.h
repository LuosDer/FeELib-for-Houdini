...
#ifndef __SOP_FeE_h__
#define __SOP_FeE_h__
...
class SOP_FeE : public SOP_Node
{
public:
    static PRM_Template *buildTemplates();
    static OP_Node *myConstructor(OP_Network *net, const char *name, OP_Operator *op)
    {
        return new SOP_FeE(net, name, op);
    }
...
protected:
    SOP_FeE(OP_Network *net, const char *name, OP_Operator *op)
