...
#include "SOP_FeE_HasEdgeGroup_2_0.h"


#include "SOP_FeE_HasEdgeGroup_2_0.proto.h"
...
using namespace SOP_FeE_HasEdgeGroup_2_0_Namespace;
...
PRM_Template*
SOP_FeE_HasEdgeGroup_2_0::buildTemplates()
{
    static PRM_TemplateBuilder templ("SOP_FeE_HasEdgeGroup_2_0.C"_sh, theDsFile);
    if (templ.justBuilt())
    {
...
const UT_StringHolder SOP_FeE_HasEdgeGroup_2_0::theSOPTypeName("FeE::hasEdgeGroup::1.0"_sh);

void
newSopOperator(OP_OperatorTable* table)
{
    OP_Operator* newOp = new OP_Operator(
        SOP_FeE_HasEdgeGroup_2_0::theSOPTypeName,
        "FeE Has Edge Group",
        SOP_FeE_HasEdgeGroup_2_0::myConstructor,
        SOP_FeE_HasEdgeGroup_2_0::buildTemplates(),
        1,
        1,
        nullptr,
...
//class SOP_FeE_HasEdgeGroup_2_0Cache : public SOP_NodeCache
//{
//public:
//    SOP_FeE_HasEdgeGroup_2_0Cache() : SOP_NodeCache(),
//        myPrevOutputDetailID(-1)
//    {}
//    ~SOP_FeE_HasEdgeGroup_2_0Cache() override {}
//
//    int64 myPrevOutputDetailID;
//};


class SOP_FeE_HasEdgeGroup_2_0Verb : public SOP_NodeVerb
{
public:
    SOP_FeE_HasEdgeGroup_2_0Verb() {}
    virtual ~SOP_FeE_HasEdgeGroup_2_0Verb() {}

    virtual SOP_NodeParms *allocParms() const { return new SOP_FeE_HasEdgeGroup_2_0Parms(); }
    //virtual SOP_NodeCache* allocCache() const { return new SOP_FeE_HasEdgeGroup_2_0Cache(); }
    virtual UT_StringHolder name() const { return SOP_FeE_HasEdgeGroup_2_0::theSOPTypeName; }
    ...
    static const SOP_NodeVerb::Register<SOP_FeE_HasEdgeGroup_2_0Verb> theVerb;
};

// The static member variable definition has to be outside the class definition.
// The declaration is inside the class.
const SOP_NodeVerb::Register<SOP_FeE_HasEdgeGroup_2_0Verb> SOP_FeE_HasEdgeGroup_2_0Verb::theVerb;

const SOP_NodeVerb *
SOP_FeE_HasEdgeGroup_2_0::cookVerb() const 
{ 
    return SOP_FeE_HasEdgeGroup_2_0Verb::theVerb.get();
}
...
static GA_GroupType
sopCombineGroupType(SOP_FeE_HasEdgeGroup_2_0Parms::CombineGroupType parmgrouptype)
{
    using namespace SOP_FeE_HasEdgeGroup_2_0Enums;
...
static GA_GroupType
sopGroupType(SOP_FeE_HasEdgeGroup_2_0Parms::GroupType parmgrouptype)
{
    using namespace SOP_FeE_HasEdgeGroup_2_0Enums;
    switch (parmgrouptype)
    {
...
void
SOP_FeE_HasEdgeGroup_2_0Verb::cook(const SOP_NodeVerb::CookParms &cookparms) const
{
    auto &&sopparms = cookparms.parms<SOP_FeE_HasEdgeGroup_2_0Parms>();
    GA_Detail* const outGeo0 = cookparms.gdh().gdpNC();
    //auto sopcache = (SOP_FeE_HasEdgeGroup_2_0Cache*)cookparms.cache();
    ...
    GFE_GroupUnion::groupUnion(outGeo0, combineGroup, geo0Group);
    ...
    //GA_VertexGroup* unsharedGroup = GFE_VertexNextEquiv::addGroupVertexNextEquiv(outGeo0, "__topo_unshared_SOP_FeE_HasEdgeGroup_2_0", geo0VtxGroup);
...
namespace SOP_FeE_HasEdgeGroup_2_0_Namespace {

} // End SOP_FeE_HasEdgeGroup_2_0_Namespace namespace
